...
| `actualModes` | object | Actual runtime modes observed for languages with an explicit Phase 1 contract. Razor may report `deferred` until component resolution and source mapping are implemented. |
